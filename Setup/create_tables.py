...
#User_Settings table
mycursor.execute("CREATE TABLE User_Settings (user_id BIGINT, likes TINYINT, reply TINYINT, retweet TINYINT, verified TINYINT, reply_string VARCHAR(255), updated_date DATETIME)")
